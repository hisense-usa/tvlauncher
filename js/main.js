...
function launchTest(testId, testType) {
  ...
  if (testCounter === 1) {
    $('#timeoutDialog > div > div:nth-of-type(1) > span').text("This test will take about 5 minutes. Please make sure you have this much of uninterrupted time.");
    $('#timeoutDialog > div > div:nth-of-type(3) > span').text("Use your keyboard to navigate the following screens:");
